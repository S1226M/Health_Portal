    ...
    <main className="min-h-screen bg-white pt-10">
      ...
      <div className="max-w-7xl mx-auto px-8 mb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {/* Card 1 */}
          <Link
            href="/videoconsult/viewconsult"
            className="border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer block text-decoration-none"
          >
            <img
            ...
            />
            <div className="p-4">
              <h4 className="text-gray-600 font-semibold mx-2">
      ...
      <div className="max-w-7xl mx-auto px-8 mb-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <Link
            ...
            className="mt-4 md:mt-0 px-6 py-2 border border-blue-600 text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-colors"
          >
