                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <div className="bg-white rounded-lg p-2 shadow-sm border border-industrial-200 flex flex-col">
                            <Link href="/user/modules/sec/userProfile/myProfile" className="flex items-center gap-3 px-4 py-3 rounded-md bg-industrial-50 text-primary-600 font-bold text-[14px] transition-colors">
                                <User className="w-4 h-4" />
