    ...
    <main className="min-h-screen bg-white pt-10">
      ...
      <div className="max-w-7xl mx-auto px-8 mb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {/* Card 1 */}
          <Link href="/viewConsult" className="border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer block text-decoration-none">
          ...
          {/* Card 2 */}
          <div className="border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer">
