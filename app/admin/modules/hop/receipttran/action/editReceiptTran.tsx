...
export default async function EditReceiptTran(formData: FormData) {
    ...
    const SubTreatmentTypeID = formData.get("SubTreatmentTypeID") && formData.get("SubTreatmentTypeID") !== "0" ? parseInt(formData.get("SubTreatmentTypeID") as string) : null;
    const MedicineID = formData.get("MedicineID") && formData.get("MedicineID") !== "0" ? parseInt(formData.get("MedicineID") as string) : null;
