...
export default async function EditOrderOfMedicinePage({
  params,
}: {
  ...
  // Fetch relations
  const medicines = await prisma.phm_medicine.findMany({
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      >
        <input
          type="hidden"
          name="OrderOfMedicineID"
          value={data?.OrderOfMedicineID}
        />
      </FormContainer>
    </div>
  );
