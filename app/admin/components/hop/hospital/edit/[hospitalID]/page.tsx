...
export default async function EditHospitalPage({ params }: { params: Promise<{ hospitalID: string }> }) {
    ...
    const serializedHospital = hospital ? JSON.parse(JSON.stringify(hospital)) : null;
