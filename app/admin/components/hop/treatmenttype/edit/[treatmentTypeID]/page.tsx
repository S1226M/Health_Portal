...
export default async function EditTreatmentTypePage({
  params,
}: {
  ...
  const serializedData = treatmentType
    ? JSON.parse(JSON.stringify(treatmentType))
    : null;
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      >
        <input
          ...
          value={treatmentType?.TreatmentTypeID}
        />
      </FormContainer>
    </div>
  );
