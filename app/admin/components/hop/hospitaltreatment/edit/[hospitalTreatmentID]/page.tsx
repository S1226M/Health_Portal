...
export default async function EditHospitalTreatmentPage({ params }: { params: Promise<{ hospitalTreatmentID: string }> }) {
    ...
    const serializedData = hospitalTreatment ? JSON.parse(JSON.stringify(hospitalTreatment)) : null;
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            >
                <input type="hidden" name="HospitalTreatmentID" value={hospitalTreatment?.HospitalTreatmentID} />
            </FormContainer>
        </div>
    )
}
