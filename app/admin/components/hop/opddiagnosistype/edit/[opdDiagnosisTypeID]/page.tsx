...
export default async function EditOPDDiagnosisTypePage({ params }: { params: Promise<{ opdDiagnosisTypeID: string }> }) {
    ...
    const serializedData = opdDiagnosisType ? JSON.parse(JSON.stringify(opdDiagnosisType)) : null;
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            >
                <input type="hidden" name="OPDDiagnosisTypeID" value={opdDiagnosisType?.OPDDiagnosisTypeID} />
            </FormContainer>
        </div>
    )
}
