...
export default async function EditDoctorReviewPage({
  params,
}: {
  ...
  const serializedData = doctorReview
    ? JSON.parse(JSON.stringify(doctorReview))
    : null;
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      >
        <input
          type="hidden"
          name="DoctorReviewID"
          value={doctorReview?.DoctorReviewID}
        />
      </FormContainer>
    </div>
  );
