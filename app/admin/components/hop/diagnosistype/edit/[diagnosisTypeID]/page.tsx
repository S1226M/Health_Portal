...
export default async function EditDiagnosisTypePage({
  params,
}: {
  ...
  const serializedData = diagnosisType
    ? JSON.parse(JSON.stringify(diagnosisType))
    : null;
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      >
        <input
          ...
          value={diagnosisType?.DiagnosisTypeID}
        />
      </FormContainer>
    </div>
  );
