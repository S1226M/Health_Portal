...
export default async function EditSubTreatmentTypePage({
  params,
}: {
  ...
  const serializedData = subTreatmentType
    ? JSON.parse(JSON.stringify(subTreatmentType))
    : null;
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      >
        <input
          type="hidden"
          name="SubTreatmentTypeID"
          value={subTreatmentType?.SubTreatmentTypeID}
        />
      </FormContainer>
    </div>
  );
