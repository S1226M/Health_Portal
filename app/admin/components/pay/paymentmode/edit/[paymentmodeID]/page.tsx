...
export default async function PaymentModeEdit({params}:{params:Promise<{paymentmodeID: string}>}) {
    ...
    return(
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            >
                <input type="hidden" name="PaymentMode" value={paymentMode?.PaymentModeID} />
            </FormContainer>
        </div>   
    )
